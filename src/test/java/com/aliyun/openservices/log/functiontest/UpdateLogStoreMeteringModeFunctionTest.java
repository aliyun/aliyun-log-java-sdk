...
public class UpdateLogStoreMeteringModeFunctionTest extends MetaAPIBaseFunctionTest {
    ...
    public void testCreateLogStore() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(ex.getMessage(), "The metering mode is already " + Consts.CHARGE_BY_FUNCTION + ".");
        }
        ...
        try {
            ...
            Assert.assertEquals(ex.getMessage(), "The operation is not supported for current mode.");
        }
        ...
        try {
            ...
            Assert.assertEquals(ex.getMessage(), "The operation is not supported for metricstore.");
        }
    }
