...
public interface LogService {
	 ...
	 */
    GetHistogramsResponse GetHistograms(String project,
                                        String logstore,
                                        int from,
                                        int to,
                                        String topic,
                                        String query) throws LogException;
	 ...
	 */
    GetHistogramsResponse GetHistograms(GetHistogramsRequest request) throws LogException;
	 ...
	 *             if required parameter is null
	 */
	ListLogStoresResponse ListLogStores(ListLogStoresRequest request) throws LogException;
	 ...
	 *             if any string argument in request is empty
	 */
	GetCursorTimeResponse GetCursorTime(GetCursorTimeRequest request) throws LogException;
	/**
	 ...
	 *             if project or logstore in request is empty
	 */
	ListShardResponse MergeShards(String project, String logStore, int shardId) throws LogException;
	 ...
	 */
	BatchGetLogResponse BatchGetLog(String project, String logStore,
									int shardId, int count, String cursor, String endCursor)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	GetAppliedConfigResponse GetAppliedConfig(String project, String groupName) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	GetAppliedMachineGroupsResponse GetAppliedMachineGroups(String project, String configName)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	GetAppliedMachineGroupsResponse GetAppliedMachineGroups(GetAppliedMachineGroupRequest request)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	CreateMachineGroupResponse CreateMachineGroup(String project, MachineGroup group)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	CreateMachineGroupResponse CreateMachineGroup(CreateMachineGroupRequest request)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	UpdateMachineGroupResponse UpdateMachineGroup(String project, MachineGroup group)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	UpdateMachineGroupResponse UpdateMachineGroup(UpdateMachineGroupRequest request)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	GetMachineGroupResponse GetMachineGroup(String project, String groupName) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
	ApproveMachineGroupResponse ApproveMachineGroup(String project, String groupName)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ApproveMachineGroupResponse ApproveMachineGroup(ApproveMachineGroupRequest request)
            throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    DeleteMachineGroupResponse DeleteMachineGroup(String project, String groupName)
            throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    DeleteMachineGroupResponse DeleteMachineGroup(DeleteMachineGroupRequest request)
            throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ListMachinesResponse ListMachines(String project, String machineGroup, int offset, int size)
            throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ListMachineGroupResponse ListMachineGroup(String project, int offSet, int size)
            throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ListMachineGroupResponse ListMachineGroup(String project, String groupName,
                                              int offSet, int size) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ApplyConfigToMachineGroupResponse ApplyConfigToMachineGroup(String project,
                                                                String groupName,
                                                                String configName)
			throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ListACLResponse ListACL(String project, String logStore, int offSet, int size)
            throws LogException;
	 ...
	 * @throws LogException
	 *             if any error happen when creating logstore
	 *
	 * @throws NullPointerException
	 *             if any parameter is null
	 * @throws IllegalArgumentException
	 *             if project is empty
	 */
    CreateLogStoreResponse CreateLogStore(String project, LogStore logStore) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    CreateLogStoreResponse CreateLogStore(CreateLogStoreRequest request) throws LogException;
	 ...
	 *             if project is empty
	 */
    UpdateLogStoreResponse UpdateLogStore(String project, LogStore logStore) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    UpdateLogStoreResponse UpdateLogStore(UpdateLogStoreRequest request) throws LogException;
	 ...
	 */
    DeleteLogStoreResponse DeleteLogStore(String project, String logStoreName) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    DeleteLogStoreResponse DeleteLogStore(DeleteLogStoreRequest request) throws LogException;
	 ...
	 */
    GetLogStoreResponse GetLogStore(String project, String logStoreName) throws LogException;
	 ...
	 */
    CreateIndexResponse CreateIndex(String project, String logStore, Index index)
            throws LogException;
	 ...
	 *             if any string parameter is empty
	 */
    UpdateIndexResponse UpdateIndex(String project, String logStore, Index index)
            throws LogException;
	 ...
	 *             if any string parameter is empty
	 */
    GetIndexResponse GetIndex(String project, String logStore)
			throws LogException;
    ...
    GetIndexStringResponse GetIndexString(GetIndexRequest request) throws LogException;
    ...
    CreateConsumerGroupResponse CreateConsumerGroup(String project,
                                                    String logStore,
                                                    ConsumerGroup consumerGroup) throws LogException;
    ...
    DeleteConsumerGroupResponse DeleteConsumerGroup(String project,
                                                    String logStore,
                                                    String consumerGroup) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ConsumerGroupUpdateCheckPointResponse UpdateCheckPoint(String project,
                                                           String logStore,
                                                           String consumerGroup,
                                                           String consumer,
                                                           int shard,
	 ...
	 *             if any required string parameter is empty
	 */
    CreateShipperResponse CreateShipper(String project,
                                        String logStore,
                                        String shipperName,
                                        ShipperConfig shipConfig) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    UpdateShipperResponse UpdateShipper(String project,
                                        String logStore,
                                        String shipperName,
                                        ShipperConfig shipConfig) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    DeleteShipperResponse DeleteShipper(String project,
                                        String logStore,
	 ...
	 *             if any required string parameter is empty
	 */
    GetShipperResponse GetShipperConfig(String project,
                                        String logStore,
                                        String shipperName) throws LogException;
	 ...
	 *             if any required string parameter is empty
	 */
    ListShipperResponse ListShipper(String project, String logStore) throws LogException;
    ...
    RetryShipperTasksResponse RetryShipperTasks(String project,
                                                String logStore,
                                                String shipperName,
                                                List<String> taskList) throws LogException;
